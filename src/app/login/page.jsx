    ...
    <div>
      ...
      <form>
           ...
           <div className='flex flex-col  items-center w-screen h-screen'>
              <h3 className='mt-8 mb-4 text-xl font-bold  text-amber-700'>Login here!</h3>
              ...
              <div className='w-[70%] sm:w-[60%] md:w-[500px] h-[56%]  flex flex-col items-center'>
                 ...
                 <button onClick={handleSubmit} className='w-[70%] min-w-[250px] h-8 rounded-full mt-8 bg-gray-600  text-white font-inter font-semibold text-[15px]'>Login</button>
                 ...
                 <Link className="mt-12 italic text-amber-600" href='/register'>Not Registered?  <spnan className='text-amber-700 font-semibold'>Sign Up</spnan> here!</Link>
              </div>
