     ...
     // if(session){
      ...
      return (
        <div className='flex flex-col  items-center w-screen h-screen'>
          <h3 className='mt-8 text-xl font-bold  text-amber-600'>Write your Post</h3>
          {/* <div className='w-[70%] sm:w-[60%] md:w-[500px] h-[60%] border-x border-green-500 mt-6 rounded-md '>
            ...
            <form className='w-[90%] sm:w-[80%] md:w-[700px] h-[55%]   flex flex-col items-center' id='regUserForm' onSubmit={onSubmit} >        
              <div className='w-[80%] min-w-[250px] mt-2'>
                <h2 className='font-semibold text-amber-600 text-sm '>Title: </h2>
              ...
              <div className='w-[80%] min-w-[250px] mt-2'>
                <h2 className='font-semibold text-amber-600 text-sm '>Content: </h2>
              ...
              <button type='submit' className='w-[80%] min-w-[350px] h-12 p-1 rounded-full mt-8 bg-gray-600  text-white font-inter text-[15px] '>Create Post</button>
            </form>
